...
class BombDefusalGame:
    def __init__(self):
        ...
        # Load player image
        self.player_image = pygame.image.load('player.png')  # Replace 'player.png' with your image file
        self.player_image = pygame.transform.scale(self.player_image, (self.CIRCLE_RADIUS * 2, self.CIRCLE_RADIUS * 2))

        # Load bomb image
        self.bomb_image = pygame.image.load('bomb.png')  # Replace 'bomb.png' with your image file
